...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Kacaya " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cozimissu.com", "139.59.252.249"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"kacayatools.com", "testnet-seed.kacayatools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Kacaya is probably already running."), addrBind.ToString().c_str());
        else
